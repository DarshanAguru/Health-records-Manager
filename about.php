...
<!-- 
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          ...
          <?php 
            ...
            <!-- Top Navigation Menu -->
<div class="topnav">
  <a href="about.php" class="active-nav"><center><b>About Us</b></center></a>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 wow fadeInUp">
          <h1 class="text-center mb-3">Welcome to Your Personal Health Wallet!</h1>
          <div class="text-lg">
              <p> Health Record (HR) is an electronic version of a patients medical history, that is maintained by the provider over time, and may include all of the key administrative clinical data relevant to that persons care under a particular provider, including demographics, progress notes, problems, medications, vital signs, past medical history, immunizations, laboratory data and radiology reports.</p>
          </div>
        </div>
