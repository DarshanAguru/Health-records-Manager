    ...
    if(move_uploaded_file($tmp,$folder))
        {
            ...
            try{
                    ...
                    $sql  = "INSERT INTO `user_data` (userid,title,date,files,recordtype, imgid, uid) VALUES ('".$_SESSION['userid']."', '$title', '$dte', '$filename','$rt', '".md5($filename)."', '".$uid."')";
                    $smt = $conn->query($sql);  
      ...
      <form method="post" action="" class="contact-form mt-5" enctype="multipart/form-data">
        <div class="row mb-3">
          <div class="col-sm-6 py-2 wow fadeInRight">
            <label for="uid"><b>Patient ID</b></label>
            <input type="text" id="uid" name ="uid" class="form-control" placeholder="Patient ID" required>
          </div>
          </div>
        <div class="row mb-3">
          <div class="col-sm-6 py-2 wow fadeInRight">
